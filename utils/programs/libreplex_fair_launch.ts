    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "allowBurn";
            docs: ["used for variable-rate swaps"];
            type: "bool";
          },
          {
...
export default function (connection: Connection, keypair: Keypair) {
  return new Program<LibreplexFairLaunch>(
    IDL,
    new PublicKey("2LbfyG5KQgskqqb7juHTmaQu2beLDMa61NpHkrrbmiCf"),
